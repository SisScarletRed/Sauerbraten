...
VAR(editmathidewater, 0, 0, 1);
VAR(editmathideclip, 0, 0, 1);
VAR(editmathideglass, 0, 0, 1);
VAR(editmathidenoclip, 0, 0, 1);
VAR(editmathidelava, 0, 0, 1);
VAR(editmathidegameclip, 0, 0, 1);
VAR(editmathidedeath, 0, 0, 1);
VAR(editmathidealpha, 0, 0, 1);

bool dontshowmaterial(int mat)
{
    return (editmathidewater && mat==MAT_WATER) || (editmathideclip && mat==MAT_CLIP) ||
           (editmathideglass && mat==MAT_GLASS) || (editmathidenoclip && mat==MAT_NOCLIP) ||
           (editmathidelava && mat==MAT_LAVA) || (editmathidegameclip && mat==MAT_GAMECLIP) ||
           (editmathidedeath && mat==MAT_DEATH) || (editmathidealpha && mat==MAT_ALPHA);
}
...
void rendermaterials()
{
    ...
    if(editmode && showmat && !envmapping)
    {
        ...
        loopv(vismats)
        {
            ...
            if(dontshowmaterial(m.material&~MATF_INDEX)) continue;
