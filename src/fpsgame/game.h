...
{
    { "SP", "SP", M_LOCAL | M_CLASSICSP, NULL },
    { "DMSP", "DMSP", M_LOCAL | M_DMSP, NULL },
    { "demo", "Demo", M_DEMO | M_LOCAL, NULL},
    { "ffa", "FFA", M_LOBBY, "Free For All: Collect items for ammo. Frag everyone to score points." },
    { "coop edit", "Coop Edit", M_EDIT, "Cooperative Editing: Edit maps with multiple players simultaneously." },
    { "teamplay", "Teamplay", M_TEAM, "Teamplay: Collect items for ammo. Frag \fs\f3the enemy team\fr to score points for \fs\f1your team\fr." },
    { "instagib", "Instagib", M_NOITEMS | M_INSTA, "Instagib: You spawn with full rifle ammo and die instantly from one shot. There are no items. Frag everyone to score points." },
    { "insta team", "Insta Team", M_NOITEMS | M_INSTA | M_TEAM, "Instagib Team: You spawn with full rifle ammo and die instantly from one shot. There are no items. Frag \fs\f3the enemy team\fr to score points for \fs\f1your team\fr." },
    { "efficiency", "Efficiency", M_NOITEMS | M_EFFICIENCY, "Efficiency: You spawn with all weapons and armour. There are no items. Frag everyone to score points." },
    { "effic team", "Effic Team", M_NOITEMS | M_EFFICIENCY | M_TEAM, "Efficiency Team: You spawn with all weapons and armour. There are no items. Frag \fs\f3the enemy team\fr to score points for \fs\f1your team\fr." },
    { "tactics", "Tactics", M_NOITEMS | M_TACTICS, "Tactics: You spawn with two random weapons and armour. There are no items. Frag everyone to score points." },
    { "tac team", "Tac Team", M_NOITEMS | M_TACTICS | M_TEAM, "Tactics Team: You spawn with two random weapons and armour. There are no items. Frag \fs\f3the enemy team\fr to score points for \fs\f1your team\fr." },
    { "capture", "Capture", M_NOAMMO | M_TACTICS | M_CAPTURE | M_TEAM, "Capture: Capture neutral bases or steal \fs\f3enemy bases\fr by standing next to them.  \fs\f1Your team\fr scores points for every 10 seconds it holds a base. You spawn with two random weapons and armour. Collect extra ammo that spawns at \fs\f1your bases\fr. There are no ammo items." },
    { "regen capture", "Regen Capture", M_NOITEMS | M_CAPTURE | M_REGEN | M_TEAM, "Regen Capture: Capture neutral bases or steal \fs\f3enemy bases\fr by standing next to them. \fs\f1Your team\fr scores points for every 10 seconds it holds a base. Regenerate health and ammo by standing next to \fs\f1your bases\fr. There are no items." },
    { "ctf", "CTF", M_CTF | M_TEAM, "Capture The Flag: Capture \fs\f3the enemy flag\fr and bring it back to \fs\f1your flag\fr to score points for \fs\f1your team\fr. Collect items for ammo." },
    { "insta ctf", "Insta CTF", M_NOITEMS | M_INSTA | M_CTF | M_TEAM, "Instagib Capture The Flag: Capture \fs\f3the enemy flag\fr and bring it back to \fs\f1your flag\fr to score points for \fs\f1your team\fr. You spawn with full rifle ammo and die instantly from one shot. There are no items." },
    { "protect", "Protect", M_CTF | M_PROTECT | M_TEAM, "Protect The Flag: Touch \fs\f3the enemy flag\fr to score points for \fs\f1your team\fr. Pick up \fs\f1your flag\fr to protect it. \fs\f1Your team\fr loses points if a dropped flag resets. Collect items for ammo." },
    { "insta protect", "Insta Protect", M_NOITEMS | M_INSTA | M_CTF | M_PROTECT | M_TEAM, "Instagib Protect The Flag: Touch \fs\f3the enemy flag\fr to score points for \fs\f1your team\fr. Pick up \fs\f1your flag\fr to protect it. \fs\f1Your team\fr loses points if a dropped flag resets. You spawn with full rifle ammo and die instantly from one shot. There are no items." },
    { "hold", "Hold", M_CTF | M_HOLD | M_TEAM, "Hold The Flag: Hold \fs\f7the flag\fr for 20 seconds to score points for \fs\f1your team\fr. Collect items for ammo." },
    { "insta hold", "Insta Hold", M_NOITEMS | M_INSTA | M_CTF | M_HOLD | M_TEAM, "Instagib Hold The Flag: Hold \fs\f7the flag\fr for 20 seconds to score points for \fs\f1your team\fr. You spawn with full rifle ammo and die instantly from one shot. There are no items." },
    { "effic ctf", "Effic CTF", M_NOITEMS | M_EFFICIENCY | M_CTF | M_TEAM, "Efficiency Capture The Flag: Capture \fs\f3the enemy flag\fr and bring it back to \fs\f1your flag\fr to score points for \fs\f1your team\fr. You spawn with all weapons and armour. There are no items." },
    { "effic protect", "Effic Protect", M_NOITEMS | M_EFFICIENCY | M_CTF | M_PROTECT | M_TEAM, "Efficiency Protect The Flag: Touch \fs\f3the enemy flag\fr to score points for \fs\f1your team\fr. Pick up \fs\f1your flag\fr to protect it. \fs\f1Your team\fr loses points if a dropped flag resets. You spawn with all weapons and armour. There are no items." },
    { "effic hold", "Effic Hold", M_NOITEMS | M_EFFICIENCY | M_CTF | M_HOLD | M_TEAM, "Efficiency Hold The Flag: Hold \fs\f7the flag\fr for 20 seconds to score points for \fs\f1your team\fr. You spawn with all weapons and armour. There are no items." },
    { "collect", "Collect", M_COLLECT | M_TEAM, "Skull Collector: Frag \fs\f3the enemy team\fr to drop \fs\f3skulls\fr. Collect them and bring them to \fs\f3the enemy base\fr to score points for \fs\f1your team\fr or steal back \fs\f1your skulls\fr. Collect items for ammo." },
    { "insta collect", "Insta Collect", M_NOITEMS | M_INSTA | M_COLLECT | M_TEAM, "Instagib Skull Collector: Frag \fs\f3the enemy team\fr to drop \fs\f3skulls\fr. Collect them and bring them to \fs\f3the enemy base\fr to score points for \fs\f1your team\fr or steal back \fs\f1your skulls\fr. You spawn with full rifle ammo and die instantly from one shot. There are no items." },
    { "effic collect", "Effic Collect", M_NOITEMS | M_EFFICIENCY | M_COLLECT | M_TEAM, "Efficiency Skull Collector: Frag \fs\f3the enemy team\fr to drop \fs\f3skulls\fr. Collect them and bring them to \fs\f3the enemy base\fr to score points for \fs\f1your team\fr or steal back \fs\f1your skulls\fr. You spawn with all weapons and armour. There are no items." }
};
...
enum
{
    ...
    S_JUMPPAD, S_PISTOL,    // TODO: sometimes "failed to load sample "packages/sounds/null""
    ...
    S_ROCKET, S_ROCKETUW,       // TODO: "unregistered sound 105"
...
enum
{
    ...
    // DEMO STUFF
    N_CDEMO_DATERECORDED,
    N_CDEMO_CLIENTRECORDED,
    N_CDEMO_CLIENTIP,
...
static const int msgsizes[] =               // size inclusive message token, 0 for variable or not-checked sizes
{
    ...
    // DEMO STUFF
    N_CDEMO_DATERECORDED, 0,
    N_CDEMO_CLIENTRECORDED, 0,
    N_CDEMO_CLIENTIP, 0,
...
#define QUALITY_PROTOCOL_VERSION 1
#define QUALITY_DEMO_VERSION 2
#define QUALITY_DEMO_MAGIC "QUED_DEMO\0\0\0\0\0\0\0"
...
struct fpsstate
{
    ...
    void spawnstate(int gamemode)
    {
        ...
        else if(m_edit) loopi(NUMGUNS-1) ammo[1+i] = 1;
        else
        {
            armourtype = A_BLUE;
            armour = 25;
...
struct lagmeterdata
{
    reversequeue<int, LAGMETERDATASIZE> ping;
    void addping(int newping) { ping.add(newping); }
};

#define SPEEDMETERDATASIZE 300
struct speedmeterdata
{
    reversequeue<int, SPEEDMETERDATASIZE> speed;
    void addspeed(int newspeed) { speed.add(newspeed); }
};
...
struct fpsent : dynent, fpsstate
{
    ...
    int clientnum, privilege, lastupdate, plag;
    float ping;
    ...
    vec lastcollect;
    int frags, flags, deaths, totaldamage, totalshots, suicides, teamkills;
    ...
    struct speedmeterdata speeddata;
    editinfo *edit;
    ...
    struct extinfo::extplayerinfo extdata;
    bool extdatawasinit;
    ...
    char *getip()
    {
        if(!this->extdatawasinit && debugquality) conoutf("player %s's ip not yet initialized", this->name);
        return GeoIP_num_to_addr(endianswap(this->extdata.data.ip));
    }
};
...
namespace game
{
    struct clientmode
    {
        ...
        virtual float respawnwaitf(fpsent *d) { return 0.0f; }
    ...
    extern void setautorespawn();
    extern bool clientoption(const char *arg);
    extern fpsent *getclient(int cn);
    extern fpsent *newclient(int cn);
    extern void saveclantagscfg();
    extern const char *savedclantags();
    extern const char *getcolorstring(uint n, bool cubescript = false);
    extern const char *getmsgcolorstring();
    ...
    {
    public:
        template<class T> strtool &operator<<(T t) { buf << t; return buf; }
    ...
    extern const char *findplayer(int &index, const char *cadena);
    ...
    extern teaminfo *getteaminfo(const char *team);
...
namespace server
{
    ...
    extern const char *prettymodename(int n, const char *unknown = "Unknown");
